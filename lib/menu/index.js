import { defineComponent as u, resolveComponent as n, openBlock as t, createElementBlock as l, Fragment as w, createCommentVNode as s, createVNode as p, mergeProps as C, withCtx as h, renderList as M, createBlock as d, resolveDynamicComponent as x, createElementVNode as e, toDisplayString as z, useAttrs as V, isVNode as y } from "vue";
const B = /* @__PURE__ */ u({
  __name: "index",
  props: {
    // 导航菜单的数据
  ...
  setup(a) {
    return (_, r) => {
      const i = n("el-icon"), c = n("el-menu-item"), g = n("el-sub-menu"), f = n("el-menu");
      return t(), l(
        w,
        null,
        [
          s(" https://cn.vuejs.org/api/component-instance.html#attrs "),
          s(" $attrs：一个包含了组件所有透传 attributes 的对象(不包含 defineProps 中接收的属性) "),
          s(' v-bind="$attrs" 表示将父组件传递的所有属性作为当前组件的属性 '),
          p(f, C({
            ...
            default: h(() => [
              (t(!0), l(
                ...
                M(a.data, (o, v) => (t(), l(
                  ...
                  { key: v },
                  [
                    !o[a.children] || !o[a.children].length ? (t(), d(c, {
                      key: 0,
                      index: o[a.index]
                    }, {
                      default: h(() => [
                        p(
                          ...
                          {
                            default: h(() => [
                              o[a.icon] ? (t(), d(x(o[a.icon]), { key: 0 })) : s("v-if", !0)
                            ]),
                            _: 2
                            /* DYNAMIC */
                          },
                    ...
                    o[a.children] && o[a.children].length ? (t(), d(g, {
                      key: 1,
                      index: o[a.index]
                    }, {
                      title: h(() => [
                          ...
                          M(o[a.children], (m, H) => (t(), d(c, {
                            ...
                            default: h(() => [
                              p(
                                ...
                                {
                                  default: h(() => [
                                    m[a.icon] ? (t(), d(x(m[a.icon]), { key: 0 })) : s("v-if", !0)
                                  ]),
                                  _: 2
                                  /* DYNAMIC */
                                },
  ...
  for (const [i, c] of _)
    r[i] = c;
  return r;
}, A = /* @__PURE__ */ L(B, [["__scopeId", "data-v-2d763912"]]);
...
const M_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromeFilled: m0,
  CircleCheck: f0,
  CircleCheckFilled: w0,
  CircleClose: C0,
  CircleCloseFilled: z0,
  CirclePlus: B0,
  CirclePlusFilled: V0,
  Clock: A0,
  Close: q0,
  ...
  Van: Nt,
  VideoCamera: Qt,
  VideoCameraFilled: jt,
  VideoPause: Jt,
  VideoPlay: Yt,
  View: a_,
  Wallet: l_,
  WalletFilled: __,
  WarnTriangleFilled: o_,
  Warning: c_,
  WarningFilled: v_,
  Watch: h_,
  Watermelon: m_,
...
const H_ = /* @__PURE__ */ u({
  ...
  setup(a) {
    const {
      ...
      v.i = M_[v[i]];
      const m = {
        title: () => p(w, null, [p(n("el-icon"), null, {
          default: () => [p(v.i, null, null)]
        }), p("span", null, [v[_]])])
      };
      return v[c] && v[c].length ? p(n("el-sub-menu"), {
        index: v[r]
      }, {
        default: () => [g(v[c])],
        ...m
  ...
  install(a) {
    a.component("m-menu", A), a.component("m-infinite-menu", H_);
  }
};
export {
  y_ as default
